...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    /* palette tuned to Grape / Indigo / Pale-Purple */
    const vec3 baseColor1 = vec3(0.611765, 0.262745, 0.996078); /* bright violet  */
    const vec3 baseColor2 = vec3(0.298039, 0.760784, 0.913725); /* will hue-shift  */
