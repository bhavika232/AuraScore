        ...
        <div style={s.timelineBar}>
          ...
          <div style={s.timelineLabels}>
            {[0, 0.25, 0.5, 0.75, 1].map((ratio) => {
              ...
              return <span key={ratio} style={s.timelineLabel}>{`${m}:${sec}`}</span>;
            })}
          </div>
        </div>
...
function RadarSection({ metrics }) {
  ...
  const data = {
    ...
    datasets: [{
      label: "Performance",
      data: values,
      backgroundColor: "rgba(130,56,179,0.12)",
      borderColor: "#8238B3",
      borderWidth: 1.5,
      pointBackgroundColor: "#8238B3",
      pointBorderColor: "#8238B3",
      pointRadius: 4,
      pointHoverRadius: 6,
    }],
  };
  ...
  const options = {
    ...
    scales: {
      r: {
        ...
        pointLabels: {
          color: "#888",
          font: { size: 11, family: "'Rajdhani', sans-serif", weight: "500" },
        },
      },
    },
    plugins: {
    ...
    datasets: [
      {
        ...
        backgroundColor: (ctx) => {
          ...
          g.addColorStop(0, "rgba(130,56,179,0.25)");
          g.addColorStop(1, "rgba(130,56,179,0)");
          return g;
        },
        fill: true,
        tension: 0.45,
  ...
  const options = {
    ...
    scales: {
      x: {
        ...
        ticks: { color: "rgba(239,217,247,0.6)", font: { size: 10 } },
        border: { color: "rgba(255,255,255,0.06)" },
      },
      y: {
        min: 40, max: 100,
        grid: { color: "rgba(255,255,255,0.04)" },
        ticks: { color: "rgba(239,217,247,0.6)", font: { size: 10 }, callback: (v) => `${v}%` },
        border: { color: "rgba(255,255,255,0.06)" },
      },
    },
    plugins: {
...
export default function Results() {
  ...
  const data = raw
    ? {
      ...
      verdict: raw.verdict || getVerdict(raw.score ?? raw.confidence ?? FALLBACK.score).label,
...
const s = {
  ...
  header: {
    ...
    padding: "18px 32px", borderBottom: "1px solid rgba(130,56,179,0.12)",
    background: "rgba(3,4,10,0.85)", backdropFilter: "blur(12px)",
    position: "sticky", top: 0, zIndex: 50,
  },
  logoMark: { display: "flex", alignItems: "center", gap: 8 },
  logoDot: { width: 8, height: 8, borderRadius: "50%", background: "#8238B3", boxShadow: "0 0 12px #8238B3" },
  ...
  newSessionBtn: {
    ...
    background: "rgba(130,56,179,0.08)", border: "1px solid rgba(130,56,179,0.2)",
    color: "#8238B3", cursor: "pointer", fontSize: 12, fontFamily: "'Orbitron', monospace", fontWeight: 500,
    transition: "all 0.2s",
  },
  ...
  sectionIconWrap: {
    ...
    background: "rgba(130,56,179,0.08)", border: "1px solid rgba(130,56,179,0.15)",
  ...
  sectionSub: { fontSize: 12, color: "rgba(239,217,247,0.6)", marginTop: 2 },

  // Video section
  videoSection: {
    background: "#280055", border: "1px solid rgba(130,56,179,0.15)",
  ...
  videoPlaceholder: {
    width: "100%", height: 300, background: "#280055", borderRadius: 10,
  ...
  activeToast: {
    ...
    background: "#280055", borderWidth: 1, borderStyle: "solid",
